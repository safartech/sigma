                ...
                <div class="modal-dialog custom-width">
                    <div class="modal-content">
                        <div class="modal-header" style="background-color: #34a853;">
                            ...
                            <h3 class="modal-title">Ajout élève</h3>
                        </div>
                        <div class="modal-body ">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div id="date-nsce1" data-start-view="4"  data-min-view="2" data-date-format="yyyy-mm-dd" class="input-group date">
                                    <input size="16" type="text" value="" class="form-control"><span class="input-group-addon btn btn-default"><i class="icon-th mdi mdi-calendar"></i></span>
                                </div>
