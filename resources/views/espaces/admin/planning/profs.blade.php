...
//           $('[data-toggle="tooltip"]').tooltip()
    ...
    <template id="profs" type="text\template">
        <div>

            <div class="col-lg-8">
                <div class="panel panel-default panel-border-color panel-border-color-primary">
                    <div class="panel-heading panel-heading-divider">Emplois du temps<span class="panel-subtitle">Plannification de l'emploi du temps des professeurs.</span></div>
                    <div class="panel-body">
                        ...
                        <div class="col-lg-6">
                            <div class=""><label class="control-label">Professeurs</label></div>
                            <div class="">
                                <select id="select2-prof" class="select2">
                                    ...
                                    <div class="row">
                                        <div class="form-group">
                                            <div class="col-sm-6">
                                                ...
                                                <div class="be-checkbox be-checkbox-color inline">
                                                    <input id="check10" type="checkbox" v-model="showClasses">
                                                    <label for="check10">Classes</label>
                                                </div>
                                                <div class="be-checkbox be-checkbox-color inline">
                                    ...
                                    <table class="table table-condensed table-hover table-bordered table-striped">
                                        ...
                                        <tr v-for="h in horaires">
                                            ...
                                            <td class="text-center index" :class="hooveredTd(jour,h)" @mouseover="hooverCoursTd(jour,h)" v-for="jour in jours" v-show="isWeekend(jour)" @click="showCoursUpdatorModal(jour,h)" :style="{ 'backgroud-color': getCoursMatiereColor(jour.id,h.id) }">
                                                ...
                                                <span v-show="showClasses"><i>@{{ getCoursClasse(jour,h) }}</i></span>
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
            ...
            <div id="update-cours-modal" tabindex="-1" role="dialog" class="modal fade colored-header colored-header-primary">
                <div class="modal-dialog custom-width">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label>Matiere</label>
                                        <select name="" class="form-control" v-model="selectedCours.matiere_id" style="width: 100%">
                                            <option value="0" disabled selected>Selectionner une matiere</option>
                                            <option :value="matiere.id" v-for="matiere in matieres" >@{{ matiere.intitule }}</option>
                                        </select>
                                    </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label>Classe</label>
                                        <select name="" v-model="selectedCours.classe_id" class="form-control" style="width: 100%" >
                                            <option value="0" disabled selected>Selectionner une classe</option>
                                            <option :value="classe.id" v-for="classe in classes" >@{{ classe.nom }}</option>
                                        </select>
                                    </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label>Salle</label>
                                        <select name="" class="form-control" v-model="selectedCours.salle_id" style="width: 100%" >
                                            <option value="0" disabled selected>Selectionner une salle</option>
                                            <option :value="salle.id" v-for="salle in salles" >@{{ salle.nom }}</option>
                                        </select>
                                    </div>
                        ...
                        <div class="modal-footer">
                            <div class="col-lg-12">
                                {{--<button type="button" data-dismiss="modal" @click="deleteCours()" class="btn btn-dangerX md-close">Supprimer ce cours</button>--}}
                        ...
                        <div class="modal-body">
                            <div class="">
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label>Professeur</label>
                                        <select name="" disabled class="form-control" style="width: 100%" v-model="newCours.personnel_id">
                                            {{--<option value="0" disabled selected>Selectionner une classe</option>--}}
                                            <option :value="selectedProf.id" >@{{ selectedProf.nom_complet }}</option>
                                        </select>
                                    </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label>Matiere</label>
                                        <select name="" class="form-control" v-model="newCours.matiere_id" style="width: 100%">
                                            <option value="0" disabled selected>Selectionner une matiere</option>
                                            <option :value="matiere.id" v-for="matiere in matieres" >@{{ matiere.intitule }}</option>
                                        </select>
                                    </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label>Classe</label>
                                        <select name="" class="form-control" v-model="newCours.classe_id" style="width: 100%" >
                                            <option value="0" disabled selected>Selectionner une classe</option>
                                            <option :value="classe.id" v-for="classe in classes" >@{{ classe.nom }}</option>
                                        </select>
                                    </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label>Salle</label>
                                        <select name="" class="form-control" v-model="newCours.salle_id" style="width: 100%" >
                                            <option value="0" disabled selected>Selectionner une salle</option>
                                            <option :value="salle.id" v-for="salle in salles" >@{{ salle.nom }}</option>
                                        </select>
                                    </div>
    ...
    <script type="module" src="{{ asset('js/vues/admin/planning/profs.js') }}"></script>
@endsection
