        ...
        <div>
            <div class="col-lg-8">
                <div class="panel panel-default panel-border-color panel-border-color-primary">
                    <div class="panel-heading panel-heading-divider">Emplois du temps<span class="panel-subtitle">Plannification de l'emploi du temps des classes.</span></div>
                            ...
                            <div id="classic" class="tab-pane active cont">
                                ...
                                <div class="panel-body">
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-6">
                                                ...
                                                <div class="be-checkbox be-checkbox-color inline">
                                                    ...
                                                    <label for="check12">Couleur mati�re</label>
                                                </div>
                                    ...
                                    <table class="table table-condensed table-hover table-bordered table-striped">
                                        ...
                                        <tbody>
                                        <tr>
                                            <td class="text-center"><b>5 - 15 min</b></td>
                                            <td class="text-center " style="background-color: lightgrey" colspan="5"><b>Rituel</b></td>
                                        </tr>
                                ...
                                <div class="row full-calendar">
                                    <div class="col-md-12">
                                        <table class="table ">
                                            <thead>
                                            <tr>
                                                <td class="text-center" ><span class="label label-primary" style="background-color: #4080B4">Cours disponibles - Cahier de charge non rempli.</span></td>
                ...
                <div class="modal-dialog custom-width">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <div class="col-lg-12">
                                {{--<button type="button" data-dismiss="modal" @click="deleteCours()" class="btn btn-dangerX md-close">Supprimer ce cours</button>--}}
                                <button type="button" data-dismiss="modal" @click="createNewCours()" v-show="readyToCreateCours" class="btn btn-successX md-close">Enregistrer ce cours</button>
                                <button type="button" data-dismiss="modal" class="btn btn-defaultX md-close">Quitter</button>
                            </div>
                        </div>
                    </div>
