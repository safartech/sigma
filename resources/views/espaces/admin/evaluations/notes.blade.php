                ...
                <div class="panel panel-default">
                    <div class="panel-heading">Liste des Notes d'évaluations:
                        ...
                        <div class="tools">
                            ...
                            <span class="icon mdi mdi-close-circle" @click="hideInputs()"></span>
                    ...
                    <div class="panel-body">
                        <table id="mainTable" class="table table-condensed table-hover table-bordered table-striped">
                            ...
                            <tr v-for="eleve in eleves">
                                <td @click="eleveFocus(eleve)">@{{ eleve.nom_complet }}</td>
                                <td class="text-center dark"><b style="font-size: 14px">@{{ getMoyenne(eleve.evaluations) }}</b></td>
                                {{--<td class="number">1.580</td>--}}
                                {{--<td class="number">1.580</td>--}}
                                <td @click="noteFocus(evaluation)" class="text-center" v-for="evaluation in eleve.evaluations">
                                    <span v-show="!showNoteInput(evaluation)">@{{ evaluation.pivot.note }}</span>
                                    <input  type="number" max="20" min="0" class="form-control" v-model="evaluation.pivot.note" v-show="showNoteInput(evaluation)" @blur="noteBlur(eleve,evaluation)">
                                </td>
                            </tr>
                ...
                <div class="modal-dialog custom-width">
                    <div class="modal-content">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="form-group col-lg-6">
                                        <label>Date de l'évaluation <span class="label label-info"><b> @{{ moment(selectedEvaluation.date,'DD MMM YYYY') }} </b></span></label>
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" @click="updateEvaluation()" data-dismiss="modal" class="btn btn-warningX md-close">Modifier l'évaluation</button>
