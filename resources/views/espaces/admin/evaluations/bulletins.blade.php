                                ...
                                <div class="col-lg-4">
                                    <div class="btn-toolbar">
                                        ...
                                        <div  class="" role="group">
                                            ...
                                            <a :href="printLink(0)" target="_blank" class="btn-xl btn btn-default " v-show="showBulletin" data-toggle="tooltip" data-placement="top" title="Imprimer le bulletin"><i class="icon mdi mdi-print"></i></a>
                                            ...
                                            {{--<a href="#" class="btn-xl btn btn-danger  btn-default " data-toggle="tooltip" @click="saveMoys()" v-show="showBulletin" data-placement="top" title="Sauvegarder les moyennes gÃ©nÃ©rales des élèves de cette classe"><i class="icon mdi mdi-settings"></i></a>--}}
...
<div class="col-lg-12">
                    <div class="panel panel-default" v-show="showElevesList">
                        <div class="panel-heading">ElÃ¨ves
                        ...
                        <div class="panel-body">
                            <table class="table table-condensed table-hover table-bordered table-striped">
                                ...
                                <tr>
                                    ...
                                    <th class="text-center">PrÃ©noms</th>
                ...
                <div id="retard-modal" tabindex="-1" role="dialog" class="modal fade">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <button type="button" data-dismiss="modal" aria-hidden="true" class="close"><span class="mdi mdi-close"></span></button>
                            ...
                            <div class="modal-body">
                                <div class="text-center">
                                    ...
                                    <h3>Retard</h3>
                                    {{--<h3>@{{ selectedEleve.nom_complet }}</h3>--}}
                                    <h3><b>@{{ getEleveName() }}</b></h3>
                                    {{--<p>Veuillez saisir l'appréciation.<br>-</p>--}}
                                    <div class="">
                                        <form action="">
                                            <div class="form-group xs-pt-10">
                                                <label>Veuillez saisir l'appréciation</label>
                                                <input id="appr-text" type="text" v-model="tempRetard" maxlength="29" placeholder="Saisir l'appréciation" class="form-control">
                                            </div>
                                        </form>
                                    </div>
                                    <div class="xs-mt-50">
                                        <button type="button" data-dismiss="modal" class="btn btn-space btn-default">Cancel</button>
                                        <button type="button" data-dismiss="modal" @click="setRetard()" class="btn btn-space btn-primary">Valider</button>
                                    </div>
                                </div>
                            </div>
                            <div class="modal-footer"></div>
