                ...
                <div class="modal-dialog custom-width">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" data-dismiss="modal" aria-hidden="true" class="close md-close"><span class="mdi mdi-close"></span></button>
                            <h3 class="modal-title">Modification Mati√®re</h3>
                        </div>
                        <div class="modal-body ">
                            <div class="form-group col-md-12">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="text-center">
                                ...
                                <h3>Attention!!!!</h3>
                                <p>L' ÈlÈment sera dÈfinitivement supprimer de la Base de Donn√©e.</p>
                                <div class="xs-mt-50">
                                    <button type="button" data-dismiss="modal" class="btn btn-space btn-defaultX">Annuler</button>
...
<div class="ajustement">
             <h2 class="page-head-title ban">Mati√®res</h2>
             <ol class="breadcrumb page-head-nav">
                                 <li class="active">Liste des mati√®res</li>
                             </ol>
        </div>
        </div>
        <Matieres></Matieres>
