        ...
        <div>
            <div class="col-lg-8">
                <div class="panel panel-default panel-border-color panel-border-color-primary coll">
                    <div class="panel-heading panel-heading-divider">Evaluations<span class="panel-subtitle">Gestion des √©valuations et des notes.</span></div>
                      ...
                      <div class="col-lg-3">
                        ...
                        <div class="col-lg-3">
                            ...
                            <div class="">
                                <select id="select2-matiere" class="select2 " v-model="currentMatiereId">
                                    <option :value="null" disabled selected  >Selectionner une mati√®re</option>
                        ...
                        <div class="col-lg-3">
                            <div class="btn-toolbar">
                                ...
                                <div role="" class="">
                                    <a href="#" @click="reload" class="btn-xl btn  btn-default" data-toggle="tooltip" data-placement="top" title="Recharger les donn√©es">Recharger</a>
                                </div>
            ...
            {{--<div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-heading panel-heading-divider">LÈgende<span class="panel-subtitle">Identification des couleur</span></div>
                    <div class="panel-body">
                        <table class="table ">
                            <thead>
                            <tr>
            ...
            <div class="col-sm-12" v-show="isReady">
                <div class="panel panel-default">
                    <div class="panel-heading">Liste des Notes d'√©valuations:
                        Eleve <b>(@{{ currentEleve.nom_complet }})</b>
                        Classe <b>(@{{ currentClasse.nom }})</b>
                        Nombre d'Èvaluations <b>(@{{ evaluations.length }})</b>
                    ...
                    <div class="panel-body">
                        <table id="mainTable" class="table table-condensed table-hover table-bordered table-striped">
                            ...
                            <tr>
                                <th>Moy. classe</th>
                                <th class="text-center tooltipped" data-toggle="tooltip" data-placement="top" title="Clickez pour voir les d√©tails" v-for="evaluation in evaluations" @click="showEvaluationUpdateModal(evaluation)">@{{ evaluation.date }}</th>
                            </tr>
                            <tr>
                                <th></th>
                ...
                <div class="modal-dialog custom-width">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h3 class="modal-title"><b>DÈtail de cette l'Èvaluation</b></h3>
                        </div>
                        <div class="modal-body">
                            <div class="form-group">
                                <div class="row">
                                    <div class="form-group col-lg-6">
                                        <label>Date de l'Èvaluation <span class="label label-info"><b> @{{ moment(selectedEvaluation.date,'DD MMM YYYY') }} </b></span></label>
                        ...
                        <div class="modal-footer">
                            {{--<button type="button" @click="deleteEvaluation()" data-dismiss="modal" class="btn btn-danger md-close">Supprimer l'√©valuation</button>--}}
                            {{--<button type="button" @click="updateEvaluation()" data-dismiss="modal" class="btn btn-warning md-close">Modifier l'√©valuation</button>--}}
            ...
            <div id="create-modal" tabindex="-1" role="dialog" class="modal fade colored-header colored-header-primary">
                <div class="modal-dialog custom-width">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" data-dismiss="modal" aria-hidden="true" class="close md-close"><span class="mdi mdi-close"></span></button>
                            <h3 class="modal-title"><b>CrÈer une Èvaluation</b></h3>
                        </div>
                        <div class="modal-body">
                            <div class="form-group">
                                <div class="row">
                                    <div class="form-group col-lg-6">
                                        <label>Date de l'Èvaluation</label>
                                        <input type="date" v-model="getMoment(newEvaluation.date)" class="form-control">
                                    </div>
                                    <div class="form-group col-lg-6">
                                        <label>Type d'Èvaluation</label>
                            ...
                            <div class="row">
                                <div class="form-group col-md-12">
                                    <div class="be-checkbox">
                                        ...
                                        <label for="newEvaluation.take">Prendre cette Èvaluation en compte pour le calcul de la moyenne de classe</label>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="modal-footer">
                            <button type="button" v-show="isReady" @click="createEvaluation()" data-dismiss="modal" class="btn btn-successX md-close">Cr√©er l'√©valuation</button>
                            <button type="button"  data-dismiss="modal" class="btn btn-defaultX md-close">Quitter</button>
                        </div>
                    </div>
                </div>
