...
//           $.fn.select2.defaults.set( "theme", "bootstrap" );
                        ...
                        <div class="col-lg-3">
                            <div class="btn-toolbar">
                                ...
                                <div role="" class="">
                                    ...
                                    {{--<a href="#" class="btn-xl btn btn-default " data-toggle="tooltip" data-placement="top" title="Imprimer fiche de notes"><i class="icon mdi mdi-print"></i></a>--}}
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">Liste des Notes d'évaluations:
                        ...
                        <div class="tools">
                            ...
                            <span class="icon mdi mdi-close-circle" @click="clickedEvaluationColumn = {}"></span>
                    ...
                    <div class="panel-body">
                        ...
                        <table id="mainTable" class="table table-condensed table-hover table-bordered table-striped">
                            ...
                            <tr>
                                <th></th>
                                <th>Moy. classe</th>
                                {{--<th class="number">Appr�ciation</th>--}}
                                {{--<th class="number">Users</th>--}}
                                <th class="text-center" :class="evaluation.type.bootstrap" v-for="evaluation in evaluations" @click="showEvaluationUpdateModal(evaluation)">@{{ evaluation.date }}</th>
                            </tr>
                            <tr>
                                <th class="">@{{ eleves.length }} élèves </th>
                                <th></th>
                                <th class="text-center" :class="taken(evaluation)" v-for="evaluation in evaluations">@{{ evaluation.type.indice}}</th>
                            </tr>
                            </thead>
                            <tbody>
                            <tr v-for="eleve in eleves">
                                <td>@{{ eleve.nom_complet }}</td>
                                <td class="text-center">@{{ getMoyenne(eleve.evaluations) }}</td>
                                {{--<td class="number">1.580</td>--}}
                                {{--<td class="number">1.580</td>--}}
                                <td id="evaluation.pivot.id" @click="noteFocus(evaluation)" class="text-center" v-for="evaluation in eleve.evaluations">
                                    <span v-show="!showNoteInput(evaluation)">@{{ evaluation.pivot.note }}</span>
                                    <input :id="evaluation.pivot.id" type="number" max="20" min="0" class="form-control" ref="evaluation.pivot.note" v-model="evaluation.pivot.note" v-show="showNoteInput(evaluation)" @blur="noteBlur(eleve,evaluation)">
                                </td>
                            </tr>
                ...
                <div class="modal-dialog custom-width">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h3 class="modal-title"><b>Modifier l'�valuation</b></h3>
                        </div>
                        <div class="modal-body">
                            ...
                            <div class="row">
                                <div class="form-group col-md-12">
                                    <div class="be-checkbox">
                                        ...
                                        <label for="newEvaluation.take">Prendre cette évaluation en compte pour le calcul de la moyenne de classe</label>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="modal-footer">
                            <button type="button" v-show="isReady" @click="createEvaluation()" data-dismiss="modal" class="btn btn-info md-close">Créer l'évaluation</button>
                            <button type="button"  data-dismiss="modal" class="btn btn-defaultX md-close">Quitter</button>
                        </div>
                    </div>
                </div>
    ...
    <script type="module" src="{{ asset('js/vues/prof/evaluations/notes.js') }}"></script>
@endsection
