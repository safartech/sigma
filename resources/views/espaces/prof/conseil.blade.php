        ...
        <div>
            <div class="col-lg-12">
                <div class="panel panel-default panel-border-color panel-border-color-primary">
                    <div class="panel-heading panel-heading-divider">Conseil de classes<span class="panel-subtitle">Definir l'assiduités des élèves lors du conseil de classe chaque trimestre.</span></div>
                    ...
                    <div class="panel-body">
                        <table id="mainTable" class="table table-condensed table-hover table-bordered table-striped">
                            ...
                            <tr v-for="(eleve,i) in selectedClasse.eleves">
                                ...
                                <td class="text-center">@{{ getEleveAbsences(eleve) }}</td>
                                <td class="text-center">@{{ getEleveAG(eleve) }}</td>
