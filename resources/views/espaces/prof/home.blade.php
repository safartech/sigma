                                ...
                                <div class="panel-body">
                                    ...
                                    <table class="table table-condensed table-hover table-bordered table-striped">
                                        ...
                                        <tr v-for="h in horaires">
                                            ...
                                            <td class="text-center index" :class="hooveredTd(jour,h)" @mouseover="hooverCoursTd(jour,h)" v-for="jour in jours" v-show="isWeekend(jour)" :style="{ 'backgroud-color': getCoursMatiereColor(jour.id,h.id) }">
                                            ...
                                            <div :id="jour.nom" class="panel-collapse collapse">
                                                <div class="panel-body">
                                                    ...
                                                    <table class="table table-condensed table-hover table-bordered table-striped">
                                                        <thead>
                                                        <tr>
                                                            <td class="text-center">Horaire</td>
