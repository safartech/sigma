...
//           $.fn.select2.defaults.set( "theme", "bootstrap" );
                ...
                <div class="modal-dialog custom-width">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h3 class="modal-title"><b>Détail de cette l'évaluation</b></h3>
                        </div>
                        <div class="modal-body">
                        ...
                        <div class="modal-footer">
                            {{--<button type="button" @click="deleteEvaluation()" data-dismiss="modal" class="btn btn-dangerX md-close">Supprimer l'evaluation</button>--}}
                            {{--<button type="button" @click="updateEvaluation()" data-dismiss="modal" class="btn btn-info md-close">Modifier l'�valuation</button>--}}
            ...
            <div id="create-modal" tabindex="-1" role="dialog" class="modal fade colored-header colored-header-primary">
                <div class="modal-dialog custom-width">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <button type="button" v-show="isReady" @click="createEvaluation()" data-dismiss="modal" class="btn btn-info md-close">Cr�er l'�valuation</button>
                            <button type="button"  data-dismiss="modal" class="btn btn-defaultX md-close">Quitter</button>
                        </div>
                    </div>
                </div>
    ...
    <script type="module" src="{{ asset('js/vues/eleve/evaluations/notes.js') }}"></script>
@endsection
