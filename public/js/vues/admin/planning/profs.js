...
//            defaultDate: '2018-05-12',
    ...
    methods:{
        ...
        reload(){
            this.loadDatas()
            this.onProfChange(this.selectedProfId)
        },
        ...
        getParsedCours(j){
            ...
            if(this.selectedProfId){
                cours = j.cours.filter(x=>x.personnel_id==this.selectedProfId)
                return cours
            }
            return cours
        ...
        loadDatas(){
            instance.get('load_planning_for_profs_from_admin').then(resp=>{
        ...
        showCoursUpdatorModal(jour,h){
            ...
            if (this.cours.find(x=>x.jour_id==jour.id && x.horaire_id == h.id)){
                ...
                this.newCours.personnel_id = this.selectedProfId
