...
let notes = {
    ...
    computed:{
        isReady(){
            let bool = this.currentEleveId!=null && this.currentMatiereId!=null && this.currentSessionId!=null
            if(bool){
...
//                            alert("Note trop élevée")
        ...
        loadEvaluations(){
            instance.get('load_evaluations_parent/'+this.currentEleveId+'/'+this.currentMatiereId+'/'+this.currentSessionId).then(res=>{
                console.log(res.data)
