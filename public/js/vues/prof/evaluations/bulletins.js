...
let bulletins = {
    ...
    methods:{
        ...
        getMoy(){
            let moy = ((this.total(this.obligatoires,"moy_coef")/this.total(this.obligatoires,"coef")+this.total(this.facultatives,"moy_coef")/this.total(this.facultatives,"coef"))/2)
